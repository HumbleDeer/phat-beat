...
# This script was originally published at https://get.pimoroni.com/phatbeat.
# It has been copied to this repository (https://github.com/pimoroni/phat-beat
# for future-proofing and archival purposes in the hopes it remains useful to 
# other people in the near or far future.
...
# apt repo install
    ...
    for pkgdep in ${coredeplist[@]}; do
        if [[ "$pkgdep" == "wiringpi" ]]; then
            # todo change to a temporary file
            wget https://project-downloads.drogon.net/wiringpi-latest.deb
            sudo dpkg -i wiringpi-latest.deb
            rm -rf wiringpi-latest.deb
        elif apt_pkg_req "$pkgdep"; then
